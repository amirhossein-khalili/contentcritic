...
SPECTACULAR_SETTINGS = {
    "TITLE": "DJANGO-REST",
    "DESCRIPTION": "this is project for testing django rest frame work",
    "VERSION": "1.0.0",
